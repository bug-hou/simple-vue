...
function createRenderer(options) {
    ...
    function patchKeyedChildren(c1, c2, container, parentInstance) {
        ...
        if (l > oldR) {
            ...
            for (let i = toBePatched - 1; i >= 0; i--) {
                ...
                const anchor = (_a = c2[nextIndex + 1].el) !== null && _a !== void 0 ? _a : undefined;
    ...
    function updateComponent(n1, n2, container, parentInstance) {
        if (n1 === null || n1 === void 0 ? void 0 : n1.component) {
...
export { createApp, createRenderer, createTextVNode, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, nextTick, provide, proxyRefs, reactive, readonly, ref, renderSlots };
